      ...
      <main className="flex-1 flex items-center justify-center p-6 relative z-10 w-full">
        <form className="w-[min(440px,96vw)] flex flex-col gap-6" onSubmit={onSubmit}>
          ...
          <div className="text-center flex flex-col gap-2">
            <h1 className="m-0 font-display-lg text-3xl font-bold tracking-tight text-white">Criar conta</h1>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-semibold uppercase tracking-wide text-white/85" htmlFor="register-username">
                Usuário
              </label>
              <input
            ...
            {/* Email */}
            <div className="flex flex-col gap-2">
              <label className="text-xs font-semibold uppercase tracking-wide text-white/85" htmlFor="register-email">
                Email
              </label>
              <input
                id="register-email"
            ...
            {/* Password */}
            <div className="flex flex-col gap-2">
              <label className="text-xs font-semibold uppercase tracking-wide text-white/85" htmlFor="register-password">
                Senha
              </label>
            ...
            {/* Telefone */}
            <div className="flex flex-col gap-2">
              <label className="text-xs font-semibold uppercase tracking-wide text-white/85" htmlFor="register-telefone">
                Telefone <span className="font-normal normal-case tracking-normal text-white/40">(opcional)</span>
              </label>
              <input
          ...
          <div className="text-center pt-3">
            <p className="m-0 text-sm text-white/40">
              Já tem conta?
              <Link to="/login" className="text-white font-semibold no-underline ml-1 hover:text-inverse-primary">
                Entrar
              </Link>
            </p>
          </div>
